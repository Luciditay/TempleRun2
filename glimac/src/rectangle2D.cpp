...
const void Rectangle2D::fillBuffers() const {
    fillVBO();
    fillIBO();
    fillVAO();
}

const void Rectangle2D::fillVBO() const {
    //Bind du vbo
...
const void Rectangle2D::fillIBO() const {
    //Bind du ibo
...
const void Rectangle2D::fillVAO() const {
    //Bind
...
const void Rectangle2D::draw(const GLint& texture, const float& scaleW, const float& scaleH, const float& translateX, const float& translateY) const{
